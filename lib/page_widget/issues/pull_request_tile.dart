...
///
/// pull requests item
class PullRequestsTile extends StatelessWidget {
  /// 初始化
  const PullRequestsTile({
    Key key,
    @required this.item,
  })  : assert(item != null),
        super(key: key);
  ...
  /// item
  final $AssignedPullRequests$search$edges$node$asPullRequest item;
  ...
  Widget build(BuildContext context) {
    ...
    final pullRequestCount = item.timelineItems?.nodes
        ?.whereType<$AssignedPullRequests$search$edges$node$asPullRequest$timelineItems$nodes$asCrossReferencedEvent>()
