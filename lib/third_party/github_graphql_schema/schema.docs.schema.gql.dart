...
class SponsorsGoalKind {
  const SponsorsGoalKind(this.value);

  final String value;

  static const SponsorsGoalKind MONTHLY_SPONSORSHIP_AMOUNT =
      SponsorsGoalKind('MONTHLY_SPONSORSHIP_AMOUNT');

  static const SponsorsGoalKind TOTAL_SPONSORS_COUNT =
      SponsorsGoalKind('TOTAL_SPONSORS_COUNT');

  @override
  int get hashCode => value.hashCode;
  @override
  bool operator ==(Object o) => o is SponsorsGoalKind && o.value == value;
}
...
class VerifiableDomainOrderField {
  ...
  static const VerifiableDomainOrderField CREATED_AT =
      VerifiableDomainOrderField('CREATED_AT');
